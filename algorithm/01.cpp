...
int main() {
	...
	sort(arr, arr+n);         //! [begin, end) : arr is a pointer to the 1st element of the array i.e. arr[0]
	                     // *              arr+n is a pointer to the element after the last element of the array
